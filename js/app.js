(function() {
	...
	function getActivityText(timeThere){
		...
		thisActivity = "";
		if(timeThere>=0) { thisActivity="sleeping"; }
		if(timeThere>=6) { thisActivity="having breakfast"; }
		if(timeThere>=10) { thisActivity="at the office"; }
		if(timeThere>=11) { thisActivity="at lunch"; }
		if(timeThere>=14) { thisActivity="at the office"; }
		if(timeThere>=17) { thisActivity="having dinner"; }
		if(timeThere>=20) { thisActivity="out for a drink"; }
		if(timeThere>=22) { thisActivity="going to bed"; }
